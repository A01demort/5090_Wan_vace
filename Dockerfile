...
RUN echo '📁 커스텀 노드 및 의존성 설치 시작' && \
    ...
    git clone https://github.com/kijai/ComfyUI-WanVideoWrapper.git && cd ComfyUI-WanVideoWrapper && git fetch origin 32e5c4d && git checkout 32e5c4d || echo '⚠️ ComfyUI-WanVideoWrapper 설치 실패' && \
